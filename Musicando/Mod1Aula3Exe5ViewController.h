...
@interface Mod1Aula3Exe5ViewController : UIViewController
...
@property (strong, nonatomic) IBOutlet UIImageView *teclado;
@property (strong, nonatomic) IBOutlet UIImageView *piano;
