...
//Configura as labels de pontuação
    ...
    self.stringDePontuacao.position = CGPointMake(800, 650);
    ...
    self.labelDePontuacao.position = CGPointMake(950, 650);
    ...
    self.stringDeSimboloMusical.position = CGPointMake(710, 600);
    ...
    self.labelDeSimboloMusical.position = CGPointMake(900, 600);
